...
namespace LightHouse.Items.Interactable
{
    public class Generator : MonoBehaviour
    {
        ...
        public void StartGenerator()
        {
            IsGeneratorOn = true;
            _jerricanReceiver.gameObject.SetActive(true);
            float seconds = AudioHandlerData.AudioManager.PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_StartGenerator).clip.length - 0.15f;
        ...
        public IEnumerator DelayRoutine(float delay)
        {
            ...
            _autoGeneratedGeneratorRunningSource = AudioHandlerData.AudioManager.PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_RunningGenerator);
        }
        public void StopGenerator()
        {
            ...
            AudioHandlerData.AudioManager.PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_OffGenetrator);
        }
