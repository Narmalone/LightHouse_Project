...
namespace LightHouse.Items
{
    public class Generator : MonoBehaviour
    {
        ...
        public void StartGenerator()
        {
            IsGeneratorOn = true;
            _jerricanReceiver.gameObject.SetActive(true);
            var genStart = AudioHandlerData.AudioManager.PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_StartGenerator).clip.length;
            StartCoroutine(DelayRoutine(genStart));
        }

        public IEnumerator DelayRoutine(float delay)
        {
            yield return new WaitForSeconds(delay);
            AudioHandlerData.AudioManager.PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_RunningGenerator);
        }
