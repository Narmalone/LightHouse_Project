...
namespace LightHouse.Items.Interactable
{
    public class Generator : MonoBehaviour
    {
        ...
        public void StartGenerator()
        {
            ...
            float seconds = AudioHandlerData.AudioManager
                .PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_StartGenerator)
                .clip.length - 0.15f;
        ...
        public IEnumerator DelayRoutine(float delay)
        {
            ...
            _autoGeneratedGeneratorRunningSource = AudioHandlerData.AudioManager
                .PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_RunningGenerator);
            _isStarting = false;
        }
        ...
        public void StopGenerator()
        {
            ...
            AudioHandlerData.AudioManager
                .PlayRandomEffect(this.transform, Audio.AutoGenerated.EffectsAudioName.Effect_OffGenetrator);
        }
