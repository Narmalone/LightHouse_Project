...
{
    [CreateAssetMenu(menuName = "LightHouse/Tutorial/Steps/LookRockWithBinoculars")]
    public sealed class StepLookRockWithBinoculars : TutorialStep
    {
        [SerializeField] private LocalizedDialogueAudio _tutorial5;
        ...
        public override void Tick(TutorialContext ctx, float dt)
        {
            ...
            Vector3 to = ctx.Rock.position - camT.position;
