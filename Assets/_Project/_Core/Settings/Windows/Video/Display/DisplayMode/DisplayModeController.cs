...
namespace LightHouse.Core.Settings.Video.Display
{
    /// <summary>
    /// Contrôleur de l'option "Mode d'affichage" (plein écran, fenêtré, etc.)
    /// avec UI passive (OptionEnumPassive).
    /// 
    /// Gère un état logique unique (_currentMode) et une sélection UI (_selectedIndex).
    /// 
    /// Permet de naviguer dans les options via UI ou touches clavier,
    /// et d'appliquer ou annuler les changements.
    /// </summary>
