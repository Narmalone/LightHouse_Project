...
using LightHouse.Core.Settings.Video;
using System;
...
namespace LightHouse.Core.Settings
{
    public class SettingsMenuController : MonoBehaviour
    {
        ...
        // Internal State
        public Dictionary<CategorySetting, OptionWindowBase> _panelsByCategory;
        [SerializeField] private List<SettingsNavigationButton> _optionNavigationButtons;
        private CategorySetting _currentOpenCategory = CategorySetting.Video;
        private CategorySetting _pendingTargetCategory;
        private bool _navigationPending;

        // Option Windows
        [SerializeField] private VideoOptionsController _displayOptionsWindow;
        [SerializeField] private AudioSettingsWindow _audioOptionsWindow;
        #endregion
        ...
        private void Awake()
        {
            _optionNavigationButtons = GetComponentsInChildren<SettingsNavigationButton>().ToList();
        ...
        private void Start()
        {
            NavigateTo(CategorySetting.Video, forcePerform: true);
            Disable();
        }
        ...
        private void Btn_OnCliqued(SettingsNavigationButton obj)
        {
        ...
        {
            _panelsByCategory = new Dictionary<CategorySetting, OptionWindowBase>
            {
                { CategorySetting.Video, _displayOptionsWindow },
                { CategorySetting.Audio, _audioOptionsWindow }
        ...
        public void NavigateTo(CategorySetting category, bool forcePerform = false)
        {
        ...
        private void PerformNavigation(CategorySetting category)
        {
            HideAllPanels();
