...
{
    [SgmPage("Core/Settings", "Settings", order: 0)]
    public sealed class SettingsPage : IToolPage
    {
        ...
        public void Build(VisualElement root, NavContext ctx)
        {
            ...
            var desc = new Label("Configure les Settings. Utilise les sous-catégories ci-dessous.");
            ...
            if (count == 0)
            {
                root.Add(new HelpBox(
                    "Aucune sous-page trouvée. Ajoute des pages avec des paths du type: Core/Settings/",
