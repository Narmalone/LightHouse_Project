...
public class TriggerSplash : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if(WaterSamplePoolManager.Instances[WaterSamplePoolManager.InstanceType.Splash] != null)
            {
                GameObject splashObject = WaterSamplePoolManager.Instances[WaterSamplePoolManager.InstanceType.Splash].getNextAvailable();
