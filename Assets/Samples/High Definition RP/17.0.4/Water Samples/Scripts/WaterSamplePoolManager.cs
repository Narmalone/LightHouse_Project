...
public class WaterSamplePoolManager : MonoBehaviour
{
    public static Dictionary<InstanceType, WaterSamplePoolManager> Instances = null;
    ...
    {
        if (Instances == null)
			Instances = new Dictionary<InstanceType, WaterSamplePoolManager>();
