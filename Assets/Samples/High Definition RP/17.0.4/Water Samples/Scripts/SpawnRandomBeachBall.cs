    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown(KeyCode.Space))
        {
            ...
            {       
                ...
                if(WaterSamplePoolManager.Instances[WaterSamplePoolManager.InstanceType.Ball] != null)
                {
                    GameObject beachBall = WaterSamplePoolManager.Instances[WaterSamplePoolManager.InstanceType.Ball].getNextAvailable();
                    if(beachBall != null)
                    {
